...
namespace HealthCare.Droid.DependencyServices.CropPhoto
{
    public class CropImageView : ImageViewTouchBase
    {
        ...
        private global::HealthCare.Droid.DependencyServices.CropPhoto.HighlightView.HitPosition motionEdge;
            ...
            switch (ev.Action)
            {
                case MotionEventActions.Down:
                    ...
                    for (int i = 0; i < hightlightViews.Count; i++)
                    {
                        ...
                        if (edge != global::HealthCare.Droid.DependencyServices.CropPhoto.HighlightView.HitPosition.None)
                        {
                            motionEdge = edge;
                            ...
                            mMotionHighlightView.Mode = 
                                (edge == global::HealthCare.Droid.DependencyServices.CropPhoto.HighlightView.HitPosition.Move)
