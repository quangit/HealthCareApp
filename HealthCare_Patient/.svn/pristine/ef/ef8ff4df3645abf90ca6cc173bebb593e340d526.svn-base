...
using HealthCare.Droid.Renderers.Calendar.MonoDroid.TimesSquare;
using HealthCare.Droid.Renderers.Calendar;
using HealthCare.Droid.Extensions;


[assembly: ExportRenderer(typeof (CalendarView), typeof (CalendarViewRenderer))]
namespace HealthCare.Droid.Renderers.Calendar
{
	using System;
	...
	/// </summary>
	public class CalendarViewRenderer : ViewRenderer<HealthCare.Controls.CalendarView, RelativeLayout>
	{
		/// <summary>
		///     The tag
		/// </summary>
		private const string TAG = "HealthCare.Droid.Renderers.Calendar.Calendar";
		...
		protected override void OnElementChanged(ElementChangedEventArgs<CalendarView> e)
		{
			...
			if (e.OldElement == null)
			{
                ...
                _picker.EnabledDateList = this.Element.EnabledDateList;
