...
[assembly: ExportRenderer(typeof(WebViewVtcPay), typeof(WebViewVtcPayRenderer))]

namespace HealthCare.Droid.Renderers
{
    public class WebViewVtcPayRenderer : WebViewRenderer
    {
        ...
        {
            private readonly WebViewVtcPayRenderer _renderer;
            private readonly Android.Webkit.WebViewClient _originalClient;

            public AuthenticatingWebViewClient(WebViewVtcPayRenderer renderer, Android.Webkit.WebViewClient originalClient)
            {
                _renderer = renderer;
