    ...
    public class CheckBoxRenderer : ViewRenderer<CheckBox, Android.Widget.CheckBox>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<CheckBox> e)
        {
            ...
            if (this.Control == null)
            {
                ...
                //checkBox.SetButtonDrawable(this.Resources.GetDrawable(Resource.Drawable.custom_checkbox));
                checkBox.CheckedChange += CheckBoxCheckedChange;
                try
                {
                    //checkBox.ButtonDrawable?.SetTint(Color.ParseColor("#2CBE71"));
                    ...
                    var checkBoxColor = Color.ParseColor("#2CBE71");
