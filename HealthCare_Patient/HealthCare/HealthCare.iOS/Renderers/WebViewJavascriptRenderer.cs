...
namespace HealthCare.iOS.Renderers
{
    ...
    {
        public new WebViewJavascript Element { get { return (WebViewJavascript)base.Element; } }
        ...
        private class AuthenticatingWebViewDelegate : UIWebViewDelegate, INSUrlConnectionDelegate
        {
            ...
            public AuthenticatingWebViewDelegate(WebViewJavascriptRenderer renderer, NSObject originalDelegate)
            {
                _renderer = renderer;
