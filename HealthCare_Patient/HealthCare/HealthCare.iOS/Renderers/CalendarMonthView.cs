...
namespace HealthCare.iOS.Renderers
{
    ...
    public class CalendarMonthView : UIView
    {
        ...
        public CalendarMonthView(DateTime selectedDate, bool showHeader, bool showNavArrows, float width = 320)
        {
            ...
            BoxWidth = Convert.ToInt32(Math.Ceiling(width / 7)) - 4;
        ...
        public override void LayoutSubviews()
        {
            ...
            _scrollView = new UIScrollView
            {
                    ...
                    ScrollEnabled = false, ContentOffset = new CGPoint(20, 0),
        ...
        private void LoadNavArrows()
        {
            ...
            _rightArrow = new CalendarArrowView(new CGRect(320 - 22 - 25 - 18, 9, 18, 22))
            {
                Color =
