...
namespace HealthCare.iOS.Renderers
{
    ...
    {
        public new WebViewCustom Element { get { return (WebViewCustom)base.Element; } }
        ...
        private class AuthenticatingWebViewDelegate : UIWebViewDelegate, INSUrlConnectionDelegate
        {
            ...
            public AuthenticatingWebViewDelegate(WebViewCustomRenderer renderer, NSObject originalDelegate)
            {
                _renderer = renderer;
