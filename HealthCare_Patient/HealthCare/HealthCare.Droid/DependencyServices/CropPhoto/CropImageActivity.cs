...
namespace HealthCare.Droid.DependencyServices.CropPhoto
{
    ...
    public class CropImageActivity : MonitoredActivity
    {
        ...
        private const int MAX_IMAGE_DIMENSION = 256;
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            switch (item.ItemId)
            {
                case Resource.Id.itCrop:
                    //do something
                    onSaveClicked();
                    return true;
                case Resource.Id.itCancel:
                    //do something
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            RequestWindowFeature(Android.Views.WindowFeatures.ContextMenu);
            ...
            //if (extras != null)
            //{
            //    var byteArray = extras.GetByteArray(PhotoEditDependencyService.IMAGE_BYTE_ARRAY);
        ...
        private async void InitBitmap()
        {
            await Task.Factory.StartNew(() =>
             {
                 bitmap = PhotoEditDependencyService.GetRightOrientationBitmap(UserViewModel.Instance.AvatarByteArray);
