...
namespace Template10.Controls
{
    ...
    public sealed partial class HamburgerMenu : UserControl
    {
        ...
        Mvvm.MvxCommand _hamburgerCommand;
        internal Mvvm.MvxCommand HamburgerCommand => _hamburgerCommand ?? (_hamburgerCommand = new Mvvm.MvxCommand(ExecuteHamburger));
        ...
        Mvvm.MvxCommand<HamburgerButtonInfo> _navCommand;
        public Mvvm.MvxCommand<HamburgerButtonInfo> NavCommand => _navCommand ?? (_navCommand = new Mvvm.MvxCommand<HamburgerButtonInfo>(ExecuteNav));
