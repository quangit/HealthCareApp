...
namespace HealthCare.Phone
{
    public partial class App : Application
    {
        ...
        public static bool IsDarkThemeUsed { get; set; }
        bool DarkThemeUsed()
        {
        ...
        public App()
        {
            ...
            IsDarkThemeUsed = DarkThemeUsed();
            // Standard XAML initialization
            InitializeComponent();
            ThemeManager.OverrideOptions = ThemeManagerOverrideOptions.None;
            ThemeManager.ToLightTheme();
            ThemeManager.SetAccentColor((this.Resources["MainBrush"] as SolidColorBrush).Color);
        ...
        private void CompleteInitializePhoneApplication(object sender, NavigationEventArgs e)
        {
            ...
            //SystemTray.BackgroundColor = (Color)Resources["MainColor"];
        ...
        private void CheckForResetNavigation(object sender, NavigationEventArgs e)
        {
            ...
            SystemTray.SetBackgroundColor(RootFrame.Content as DependencyObject, (Color)App.Current.Resources["MainColor"]);
            //SystemTray.ForegroundColor = Colors.White;
        }
